\hyphenation{mo-quea-dor}
\hyphenation{xoa-ta-rio-ma}
\hyphenation{wã-riao-no-wei}
\hyphenation{ma-kea-ma}
\hyphenation{maio-res}
\hyphenation {pu-hio-pë}
\hyphenation{kupra-rioma}
\hyphenation{Ja-piins}
\hyphenation{rea-hu-mou}
...
deles. Moravam lá, perto daquele rio.\looseness=-1
...
fazê-lo:\footnote{O \textit{wayamou} é um diálogo cerimonial realizado à noite por um hóspede e um anfitrião por ocasião de uma visita, destinado a reforçar ou restabelecer relações pacíficas entre dois \textit{xapono}. Mucura não está fazendo o \textit{wayamou} do modo correto.} 
...
--- \textls[-12]{Me deem o veneno! Vou experimentar! Quero magoar as duas mulheres
 que chegaram e me fizeram sofrer. É verdade o que estou dizendo! Vou usar agora! Deem um pedaço! --- disse ele.}\looseness=-1 
...
Onde se erguia um jutaí, Lagartixa subia, fazendo \textit{tararararara}!\looseness=-1 
...
Chamaram os do grupo dos tucanos Parawari, porque o grupo das
 Maitacas não conseguia. Os Araris estavam tendo dificuldades com seus
...
--- \textit{Kuxu!} --- kahi u këxëɨprao hërɨma. --- \textit{Kuxu!} --- kɨ kupɨ hërɨm.\looseness=-1 
...
--- Kahë ihamɨ! Kahë pë napë kõo. Pë tararema yaro, a ta hapo!\looseness=-1 
...
--- \textit{Hɨ̃ɨɨ!} Ya yuo mai kë të! Wãriti anɨ ware a waɨ mai kë të!~--- Yamonamowãro e kuma. 
...
--- Ware a xëprarɨ! --- të kuɨ ha maonɨ, të pë kirihou marë mai!\looseness=-1
...
\textls[-2]{Esse rio grande, rio abaixo, do qual vocês comem muitos peixes, na sua
 parte média, apesar de ser rio abaixo, dá para avistar a pelagem muito
 vermelha dos quatis. Eles andam por lá.}\looseness=-1
...
floresta. No meio dessa região, há o rio Kaxana.\looseness=-1
...
\textls[-7]{Salvaram-se com o fogo de Jacaré, que pegaram e espalharam.}\looseness=-1 
...
--- \textit{Pĩri}! \textit{Pĩri}! \textit{Pĩri}! \textit{Pĩri}! \textit{Pĩri}! \textit{Pĩri}! \textit{Pĩri}! \textit{Pĩri}! \textit{Pĩri}! \textit{Pĩri}! \textit{Pĩri}!~--- cantou a esposa, até chegar às águas. 
...
Eles se sentam na forquilha das árvores. Os Yanomami ficaram sentados
 ...
 jacaré-açu.\footnote{O dilúvio é tema da história do surgimento dos \textit{napë}, que está no volume \textit{Os comedores de terra}, desta mesma coleção.} Alguns se transformaram em jacaré, outros em peixe, outros em capivara. Caíram na água. Transformaram-se
...
num \textit{xapono} amigo para dançar durante a festa, e assim
...
os Amahiri, que moram em grupos como nós, mas moram lá embaixo.\looseness=-1
...
céu quase os amassar, eles escaparam.\looseness=-1
...
--- Enquanto o céu está vivo ainda --- disse o pai aos dois filhos ---~vocês vão juntos! Vão embravecer! Não cortem em silêncio!
...
região central, onde surgiu a primeira mulher,\footnote{História contada no volume \textit{Os comedores de terra}, nesta mesma coleção.} pois nossos antepassados
...
\textls[-5]{Era alta, assim como hoje? Não! Perto da casa de Escorpião, erguia-se um
...
\textls[-5]{Como as queimava, chamando assim o ódio de todos, os dois irmãos
...
de \textit{wayumɨ} e, assim, nos ensinaram. Foram por lá.}\looseness=-1
...
Assim aconteceu: o Sangue de Lua exterminou todos os que moravam
embaixo. Somente os espíritos sobreviveram, apesar de eles viverem como
...
kama pata. Kɨpɨ rë përɨpɨonowei, ɨ̃naha të kuoma.\looseness=-1
...
alcançou. Ela chegou ao lugar dos espíritos para se tornar eterna.\looseness=-1
...
pajés cantam.\footnote{O \textit{himou} é uma modalidade de diálogo cerimonial usada para trazer notícias, ou fazer um convite para uma festa. O \textit{wayamou} é um diálogo cerimonial realizado à noite por um hóspede e um anfitrião por ocasião de uma visita, destinado a reforçar ou restabelecer relações pacíficas entre dois \textit{xapono}.} Eles cantavam assim. Eles também brincavam de roubar
...
Ver o volume \textit{Os comedores de terra}, nesta coleção.\looseness=-1} 
...
--- Vamos, venha, meu irmãozinho, venha, meu netinho! Vamos depressa!

O neto rodava na frente dos dois. 
